...
crud_test.SINGULAR = 'sensorData'
crud_test.PLURAL = 'sensorData'

crud_test.FIELDS_TO_SHOW = 'date,time,value'
crud_test.CHECKING_PARAM = 'value'

crud_test.FIRST_VALUE = 13.13
crud_test.SECOND_VALUE = 17.17

crud_test.CREATE_PARAMS = {'timestamp': "'2112-12-11 12:12:12'", 'source': "'000000000000000000000003'", 'event': "'timeout'", 'meaning': "'space_radiation'",
	crud_test.CHECKING_PARAM: crud_test.FIRST_VALUE, 'units': "'eV'"}
